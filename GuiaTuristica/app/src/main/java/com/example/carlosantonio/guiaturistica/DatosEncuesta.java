...
public class DatosEncuesta {
    ...
    public static final String KEY_DRAWABLE = "drawable_data";
    public static final String KEY_INFORMACION = "contenido_data";

    private static final String DATABASE_NAME = "HotOrNotdb2";
    private static final String DATABASE_TABLE = "CochesTable";
    ...
    private static class DbHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL( "CREATE TABLE " + DATABASE_TABLE + " (" +
                            ...
                            KEY_DRAWABLE + " INTEGER NOT NULL, " +
                            KEY_INFORMACION + " TEXT NOT NULL);"
            );
    ...
    public long createEntry(String nombre, int numero, String comentario) {
        ContentValues cv = new ContentValues();
        cv.put(KEY_NOMBRE,nombre);
        cv.put(KEY_DRAWABLE, numero);
        cv.put(KEY_INFORMACION, comentario);
        return ourDatabase.insert(DATABASE_TABLE, null,cv);
    }

    public Cursor getData() {
        String[] columns = new String[]{ KEY_ROWID, KEY_NOMBRE, KEY_DRAWABLE, KEY_INFORMACION};
